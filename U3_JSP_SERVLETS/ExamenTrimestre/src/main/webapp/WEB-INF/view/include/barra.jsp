			...
			<div class="row justify-content-end" >
				<div class="col-12 text-end">
					<p class="d-flex justify-content-between bg-primary text-white p-2">
						...
						<a class="text-white" href="${pageContext.request.contextPath}/Admin/Empleados"><fmt:message key="show" /> <fmt:message key="employee" /></a>
						<a class="text-white" href="${pageContext.request.contextPath}/Admin/AddEmpleado"><fmt:message key="add" />  <fmt:message key="employee" /></a>
			...
			<div class="row justify-content-center" >
				<div class="col-12 text-center">
					<p class="d-flex justify-content-between bg-primary text-white p-2">
						...
						<fmt:message key="site"/> <fmt:message key="of"/> <fmt:message key="user"/>
